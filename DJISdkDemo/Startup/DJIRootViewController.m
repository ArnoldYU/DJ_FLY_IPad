...
//
//-(void) productConnected:(DJIBaseProduct* _Nullable) product {//当数据线与遥控器接上时触发
//    if (product) {
...
//-(void) productDisconnected {//当数据线与遥控器断开时触发
//    
...
- (IBAction)onBluetoothButtonClicked:(id)sender {//蓝牙按钮
